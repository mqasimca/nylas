...
# https://github.com/mqasimca/nylas/releases
```
...
**A: You need:**
1. **Nylas account** - Sign up at https://dashboard.nylas.com
...
- **Repository:** https://github.com/mqasimca/nylas
- **License:** MIT
...
1. **Search existing:** https://github.com/mqasimca/nylas/issues
...
```bash
# Homebrew
brew upgrade mqasimca/nylas/nylas
