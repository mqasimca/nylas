...
This is a Go CLI application for the Nylas API following **hexagonal architecture** (ports and adapters pattern). The CLI provides email, calendar, contacts, webhooks, and OTP management functionality.
