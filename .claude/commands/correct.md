...
- Start with context (e.g., "Go tests:", "Air handlers:", "Playwright:")
...
**User:** `/correct "Air handlers must return after writing error response"`

**Action:**
1. Add to CLAUDE.md under `### Project-Specific Gotchas`:
   ```
   - Air handlers: ALWAYS return after http.Error() or writing error JSON response
   ```
2. Confirm: "Added learning about Air handler error returns to CLAUDE.md"
